...
assert(/tuya_ir_standard_command_fallback_to_raw/.test(tuyaAdapter) && /endpointKind: "raw_remote_command"/.test(tuyaAdapter) && /fallback_permitted/.test(tuyaAdapter) && /rawFallbackPossible/.test(tuyaAdapter), "Tuya standard remote endpoint incompatibility can fall back to exact raw key dispatch");
