...
const moduleRegressionCases = [
  ...
  ['utility empty wording', moduleConversationResultForTest({ surface: 'facility', intent: 'service_operation', domain: 'utilities', message: 'show utility issues', entities: [] }), /no (?:utility|infrastructure service) issues/i],
