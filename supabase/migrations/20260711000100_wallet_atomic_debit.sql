-- =====================================================
-- 20260711000100 Wallet atomic debit/credit RPC
...
-- code values: "ok", "insufficient_funds", "frozen", "wallet_not_found", "invalid_amount"
...
comment on function public.oyi_debit_wallet(uuid, numeric, text, text, text, text) is
  'Security: atomic wallet debit that prevents double-spend race conditions.';
comment on function public.oyi_credit_wallet(uuid, numeric, text, text, text, text) is
  'Security: atomic wallet credit.';
